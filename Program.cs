...
namespace Mapping
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //protsess, kus muudetakse andmed ühest formadist, struktuuris
            //või süsteemist teiseks
    ...
    //miks pannakse clasii nimetuse taha dto?
    //dto tähendab - data transfer object
    //neid class kasutatakse andmete edastamiseks 
